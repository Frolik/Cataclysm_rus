...
#define DRINK(name,name1,name2,name3,name4,name5,\
rarity,price,color,container,quench,nutr,spoils,stim,\
healthy,addict,charges,fun,use_func,addict_func,des) \
	index++;itypes.push_back(new it_comest(index,rarity,price,name,name1,name2,name3,name4,name5,des,'~',\
...
DRINK("грязная вода","","","","","",	 5,  5, c_ltgreen, itm_bottle_plastic,
...
#define FOOD(name,name1,name2,name3,name4,name5,\
rarity,price,color,mat1,container,volume,weight,quench,\
...
FOOD("сырое мясо","","","","","",	60,  4,	c_red,		FLESH,	itm_null,
...
// MEDS
#define MED(name,name1,name2,name3,name4,name5,\
rarity,price,color,tool,mat,stim,healthy,addict,\
...
#define MELEE(name,name1,name2,name3,name4,name5,\
rarity,price,sym,color,mat1,mat2,volume,wgt,dam,cut,to_hit,\
              flags, des)\
	index++;itypes.push_back(new itype(index,rarity,price,name,name1,name2,name3,name4,name5,des,sym,\
...
// ARMOR
#define ARMOR(name,name1,name2,name3,name4,name5,\
rarity,price,color,mat1,mat2,volume,wgt,dam,to_hit,\
encumber,dmg_resist,cut_resist,env,warmth,storage,covers,des)\
	index++;itypes.push_back(new it_armor(index,rarity,price,name,name1,name2,name3,name4,name5,des,'[',\
...
#define AMMO(name,name1,name2,name3,name4,name5,\
rarity,price,ammo_type,color,mat,volume,wgt,dmg,AP,range,\
...
#define FUEL(name,name1,name2,name3,name4,name5,\
rarity,price,ammo_type,color,dmg,AP,range,accuracy,recoil,\
             count,des,flags) \
	index++;itypes.push_back(new it_ammo(index,rarity,price,name,name1,name2,name3,name4,name5,des,'~',\
...
#define GUN(name,name1,name2,name3,name4,name5,\
rarity,price,color,mat1,mat2,skill,ammo,volume,wgt,melee_dam,\
to_hit,dmg,accuracy,recoil,durability,burst,clip,reload_time,des,flags) \
	index++;itypes.push_back(new it_gun(index,rarity,price,name,name1,name2,name3,name4,name5,des,'(',\
...
//   gun)
#define GUNMOD(name,name1,name2,name3,name4,name5,\
               rare, value, color, mat1, mat2, volume, weight, meleedam,\
               meleecut, meleehit, acc, damage, loudness, clip, recoil, burst,\
               newtype, pistol, shotgun, smg, rifle, a_a_t, des, flags)\
  index++; itypes.push_back(new it_gunmod(index, rare, value, name,name1,name2,name3,name4,name5, des, ':',\
...
#define BOOK(name,name1,name2,name3,name4,name5,\
rarity,price,color,mat1,mat2,volume,wgt,melee_dam,to_hit,\
type,level,req,fun,intel,time,des) \
	index++;itypes.push_back(new it_book(index,rarity,price,name,name1,name2,name3,name4,name5,des,'?',\
...
//  * Others??
#define CONT(name,name1,name2,name3,name4,name5,\
rarity,price,color,mat1,mat2,volume,wgt,melee_dam,to_hit,\
contains,flags,des) \
	index++;itypes.push_back(new it_container(index,rarity,price,name,name1,name2,name3,name4,name5,des,\
 ...
 */
#define TOOL(name,name1,name2,name3,name4,name5,\
rarity,price,sym,color,mat1,mat2,volume,wgt,melee_dam,\
melee_cut,to_hit,max_charge,def_charge,charge_per_use,charge_per_sec,fuel,\
revert,func,flags,des) \
	index++;itypes.push_back(new it_tool(index,rarity,price,name,name1,name2,name3,name4,name5,des,sym,\
...
// list of options.
#define BIO(name,name1,name2,name3,name4,name5,\
 rarity, price, color, difficulty, des, ...) \
	index++;itypes.push_back(new it_bionic(index,rarity,price,name,name1,name2,name3,name4,name5,des,':',\
...
#define SOFTWARE(name,name1,name2,name3,name4,name5,\
         price, swtype, power, description) \
index++; itypes.push_back(new it_software(index, 0, price, name,name1,name2,name3,name4,name5, description,\
...
#define MACGUFFIN(name, name1,name2,name3,name4,name5,\
              price, sym, color, mat1, mat2, volume, wgt, dam, cut,\
                  to_hit, readable, function, description) \
index++; itypes.push_back(new it_macguffin(index, 0, price, name,name1,name2,name3,name4,name5, description,\
